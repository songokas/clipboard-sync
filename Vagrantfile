...
sudo rpm --import https://raw.githubusercontent.com/songokas/clipboard-sync/1.0.0/.rpm/RPM-GPG-KEY-tomasj \
  && sudo yum localinstall https://github.com/songokas/clipboard-sync/releases/download/1.0.0/clipboard-sync-1.0.0-1.x86_64.rpm
clipboard-sync --autogenerate
SCRIPT

$deb = <<-SCRIPT
wget https://github.com/songokas/clipboard-sync/releases/download/1.0.0/clipboard-sync_1.0.0_amd64.deb && sudo apt --assume-yes install ./clipboard-sync_1.0.0_amd64.deb
clipboard-sync --autogenerate
SCRIPT
