...
sudo rpm --import https://raw.githubusercontent.com/songokas/clipboard-sync/0.1.1/.rpm/RPM-GPG-KEY-tomasj \
  && sudo yum localinstall https://github.com/songokas/clipboard-sync/releases/download/0.1.1/clipboard-sync-0.1.1-1.x86_64.rpm
clipboard-sync --autogenerate
SCRIPT

$deb = <<-SCRIPT
wget https://github.com/songokas/clipboard-sync/releases/download/0.1.1/clipboard-sync_0.1.1_amd64.deb && sudo apt --assume-yes install ./clipboard-sync_0.1.1_amd64.deb
clipboard-sync --autogenerate
SCRIPT
